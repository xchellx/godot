...
void FileAccessWii::seek(size_t p_position) {
    ERR_FAIL_COND_MSG(!fp, "File must be opened before use.");
...
size_t FileAccessWii::get_position() const {
...
size_t FileAccessWii::get_len() const {
...
int FileAccessWii::get_buffer(uint8_t *p_dst, int p_length) const
{
